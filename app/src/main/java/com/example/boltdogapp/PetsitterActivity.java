...
public class PetsitterActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
            ...
            case R.id.nav_logout:
                ...
                builder.setPositiveButton("Da", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        mAuth.signOut();
                        startActivity(new Intent(PetsitterActivity.this, LoginActivity.class));
